...
class Activities(models.Model):
    ...
    unit_price_with_tax = models.DecimalField(max_digits=10, decimal_places=3,null=True)
...
class Estimate(models.Model):
    ...
    price_without_tax = models.DecimalField(max_digits=10, decimal_places=3 ,null=True, blank=True)
